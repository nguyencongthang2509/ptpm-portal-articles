                    ...
                    if (n.windowId === d.currentWindowId)
                      switch (n.type) {
                        case "s":
                          ...
                          if (
                            !f.isOriginEqual(i, p.href) ||
                            !f.isOriginEqual(s, p.href)
                          )
                            throw new Error(
                  ...
                  e.once("message", function (t) {
                    if (t) {
                      ...
                      try {
                        ...
                        return (
                          l("bad json", t), o.emit("finish"), void o.close()
                        );
                      }
                      var n = e[0],
                        r = e[1];
              ...
              e(y, d),
                ...
                (y.prototype.send = function (e) {
                  ...
                  this.readyState === y.OPEN &&
                    this._transport.send(t.quote(e));
                }),
                (y.version = x("./version")),
                (y.CONNECTING = 0),
                (y.OPEN = 1),
                      ...
                      case "a":
                        Array.isArray(t) &&
                          t.forEach(function (e) {
                            b("message", n.transport, e),
                              n.dispatchEvent(new m(e));
                          });
                        break;
                      case "m":
                        b("message", this.transport, t),
                          this.dispatchEvent(new m(t));
                        break;
                      case "c":
                        Array.isArray(t) &&
                          2 === t.length &&
                ...
                (y.prototype._close = function (t, n, r) {
                  ...
                  if (
                    (this._ir &&
                      ((o = !0), this._ir.close(), (this._ir = null)),
                    this._transport &&
        ...
        function (e, t, n) {
          ...
          r(f, i),
            ...
            (f.prototype._message = function (t) {
              if (
                (c("message", t.data), s.isOriginEqual(t.origin, this.origin))
              ) {
                var n;
                try {
                  n = JSON.parse(t.data);
        ...
        function (n, c, e) {
          (function (u) {
            (function () {
              ...
              (l.enabled = l.htmlfileEnabled || r.iframeEnabled),
                (c.exports = l);
            }.call(this));
          }.call(
            this,
              ...
              e(u, a),
                ...
                (u.prototype._createScript = function (e) {
                  ...
                  if (
                    ...
                    if (s.isOpera())
                      ((t = this.script2 =
                        c.document.createElement("script")).text =
            ...
            (function () {
              ...
              t.exports = function (e, t, n) {
                c(e, t),
                  s ||
                    (c("createForm"),
                    ((s = f.document.createElement("form")).style.display =
                      "none"),
                ...
                var o = (function (t) {
                  c("createIframe", t);
                  try {
                    return f.document.createElement(
                      '<iframe name="' + t + '">'
                    );
                  } catch (e) {
            ...
            (function () {
              ...
              t.exports = {
                ...
                isKonqueror: function () {
                  return (
                    e.navigator && /konqueror/i.test(e.navigator.userAgent)
                  );
                },
                hasDomain: function () {
            ...
            (function () {
              ...
              (_.prototype = {
                ...
                toString: function (e) {
                  ...
                  var i =
                    o +
                    ((n.protocol && n.slashes) || w(n.protocol) ? "//" : "");
                  return (
                    n.username
                      ? ((i += n.username),
