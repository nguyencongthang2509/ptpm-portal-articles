window.detailArticleCtrl = function (
  ...
  $scope.createComment = function(){
    $http.post(env.API_URL+"/comment/create", $scope.comment ).then(function(response){
      $scope.comment = {
        articlesId: $routeParams.id,
        content: "",
      };    })
  ...
  $scope.CreateReplyComment = function(){
    $http.post(env.API_URL+"/comment/create", $scope.replyCommentUser ).then(function(response){
      $scope.replyCommentUser = {
        articlesId: $routeParams.id,
        content: "",
        reply: "",
